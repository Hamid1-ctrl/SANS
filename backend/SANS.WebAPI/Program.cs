    ...
    options.Events = new JwtBearerEvents
    {
        OnTokenValidated = async context =>
        {
            ...
            if (user == null)
            {
                ...
                // but the local database record is missing (e.g. ephemeral database reset or past desync),
                // automatically recreate the user profile in DB so authentication never breaks!
